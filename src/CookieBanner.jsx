  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "0.82rem", color: "#374151", lineHeight: 1.55, margin: "0 0 12px" }}>
        We use only essential storage to make this prototype work (remembering your demo profile in your own browser). We do not use any tracking, analytics, or advertising cookies. You can still choose what you are comfortable with.
      </p>
      ...
      {showDetails && (
        <div style={{ background: "#f9fafb", borderRadius: 10, padding: "12px 14px", marginBottom: 12, fontSize: "0.8rem", color: "#374151", lineHeight: 1.55 }}>
          ...
          <ul style={{ margin: "0 0 8px", paddingLeft: 18 }}>
            <li><strong>Essential storage (always on):</strong> your prototype demo data, kept only in your own browser. Never sent to a server.</li>
          ...
          <div style={{ fontSize: "0.75rem", color: "#6b7280" }}>
            You can clear all stored demo data anytime via the in-app "Delete my account" button or by clearing your browser's site data.
          </div>
        </div>
      )}
